      ...
      <el-card v-if="login_panel" class="login-box">
        <div class="login-content">
          ...
          <el-form @submit.native.prevent :model="loginForm" status-icon :rules="rules"
            ...
            <p v-if="login_error" class="form-error mb-10">Похоже, у нас нет аккаунта с этим телефоном.
Вы можете создать новый аккаунт <nuxt-link to="/register/">здесь</nuxt-link>.</p>
            <el-form-item>
